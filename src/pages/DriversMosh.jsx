        ...
        <div className="card">
          <div className="container mx-auto">
            <div className="py-5">
              ...
              <div className="-mx-2 sm:-mx-6 px-4 sm:px-8 py-4 overflow-x-auto">
                <div className="inline-block min-w-full shadow rounded-sm overflow-hidden">
                  ...
                  <table className="min-w-full leading-normal overflow-auto">
                    <thead>
                      <tr>
                        <th className="px-5 py-3 hover:bg-gray-300 border-b-2 border-gray-200 bg-gray-100 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">
                          <div className="flex">
                            User <FaArrowDown />
                          </div>
                        </th>
